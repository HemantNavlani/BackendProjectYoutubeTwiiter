...
const getVideoById = async(req,res)=>{
    ...
    return res.status(200,video,"video details fetched successfully")
}
...
const toggelPublishStatus = async(req,res)=>{
    const {videoId} = req.params;
    const video = Video.findById(video);
    if (!video) throw new ApiError(404,"Video not found");
    ...
    return res.status(200).json(200,toggledVideoPublished,"Video is published toggled successfully");
